...
Page::Page(string tableName, int pageIndex,int y)
{
    logger.log("Page::Page");
    this->tableName = tableName;
    this->pageIndex = pageIndex;
    ...
    this->columnCount = 1;
    uint maxRowCount = matrix.maxElementsPerBlock;
...
void Page::readPage(){
    ...
    this->rows.resize(this->rowCount,vector<int>(1));
    int i = 0;
